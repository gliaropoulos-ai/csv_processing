...
from csv_preprocessing_functions import to_snake_case, read_streamlit_csv_file, write_streamlit_csv_file, curate_csv_file_generic, input_to_output_csv, optima_xlsx_preprocessing
...
if uploaded_file:
    ...
    xlsx_uploaded_df = optima_xlsx_preprocessing(xlsx_uploaded_df)
